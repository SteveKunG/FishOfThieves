...
public class GuardianFruitTreeStructure extends Structure
{
    ...
    public static final MapCodec<GuardianFruitTreeStructure> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(settingsCodec(instance)).apply(instance, GuardianFruitTreeStructure::new));
