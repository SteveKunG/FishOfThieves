...
public class SeapostPieces
{
    ...
    private static final Map<Identifier, BlockPos> PIVOTS = Map.of(SEAPOST, new BlockPos(-5, 0, 10), SEAPOST_BASE, new BlockPos(-5, 0, 11));
    private static final Map<Identifier, BlockPos> OFFSETS = Map.of(SEAPOST, new BlockPos(0, 8, 0), SEAPOST_BASE, BlockPos.ZERO);
