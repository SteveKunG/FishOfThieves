...
public class FOTLootManager
{
    ...
    {
        return builder.add(LootTableReference.lootTableReference(FOTLootTables.Gift.FISHERMAN_GIFT));
    }

    public static LootPool.Builder getFishingLoot(LootPool.Builder builder)
    {
        return builder.add(LootTableReference.lootTableReference(FOTLootTables.Fishing.FISHING_FISH));
    }

    public static LootPool.Builder getPolarBearLoot(LootPool.Builder builder)
    {
        return builder.add(LootTableReference.lootTableReference(FOTLootTables.Entities.POLAR_BEAR));
    }

    public static LootPool.Builder getOceanRuinsArchaeologyLoot(LootPool.Builder builder)
    {
        return builder.add(LootTableReference.lootTableReference(FOTLootTables.Archaeology.OCEAN_RUINS));
    }

    public static LootPool.Builder getVillageFisherLoot(LootPool.Builder builder)
    {
        return builder.add(LootTableReference.lootTableReference(FOTLootTables.Chests.VILLAGE_FISHER));
    }

    public static LootPool.Builder getBuriedTreasureLoot(LootPool.Builder builder)
    {
        return builder.add(LootTableReference.lootTableReference(FOTLootTables.Chests.BURIED_TREASURE));
    }
}