...
public class FOTLootManager
{
    ...
    public static LootPool.Builder getFishingLoot(LootPool.Builder builder)
    {
        ...
        return builder.add(FOTLootItem.lootTableItem(FOTItems.SPLASHTAIL)
                ...
                .add(FOTLootItem.lootTableItem(FOTItems.ISLEHOPPER)
                        .setWeight(40)
                        .when(FOTLocationCheck.checkLocation(FOTLocationPredicate.Builder.location().setBiomes(FOTTags.Biomes.SPAWNS_ISLEHOPPERS)).and(FOTLootItemConditions.COAST_CONTINENTALNESS.and(FOTLootItemConditions.LOW_PEAKTYPE.or(FOTLootItemConditions.MID_PEAKTYPE).or(FOTLootItemConditions.VALLEY_PEAKTYPE)))))
