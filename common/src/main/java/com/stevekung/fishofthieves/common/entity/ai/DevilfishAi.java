package com.stevekung.fishofthieves.common.entity.ai;
...
import com.stevekung.fishofthieves.common.entity.ai.behavior.CreateFishFlock;
import com.stevekung.fishofthieves.common.entity.ai.behavior.FollowFlockLeader;
import com.stevekung.fishofthieves.common.entity.ai.behavior.StartAttackingIgnoreFlockLeader;
...
public class DevilfishAi
{
    ...
    private static void initIdleActivity(Brain<Devilfish> brain)
    {
        brain.addActivity(Activity.IDLE, ImmutableList.of(
                ...
                Pair.of(2, new StartAttackingIgnoreFlockLeader<>(DevilfishAi::findNearestValidAttackTarget)),
    ...
    private static Optional<? extends LivingEntity> findNearestValidAttackTarget(Devilfish fish)
    {
