...
{
    private WreckerVariant(Supplier<Predicate<SpawnConditionContext>> condition, ResourceLocation texture, ResourceLocation glowTexture)
    {
    ...
    public static class Builder
    {
        ...
        {
            return new WreckerVariant(() -> this.condition, this.texture, this.glowTexture);
        }
