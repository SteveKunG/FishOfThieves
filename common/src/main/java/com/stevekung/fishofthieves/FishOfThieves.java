    ...
    private static List<VillagerTrades.ItemListing> getFishermanTradesByLevel(int level, List<VillagerTrades.ItemListing> list)
    {
        switch (level)
        {
            ...
            case 3 ->
            {
                ...
                list.add(new TreasuredFishMapForEmeralds(16, Shoal.FILLED_MAP_TREASURED_FISH, 1, 20, 1));
            }
            case 4 ->
            {
                ...
                list.add(new TreasuredFishMapForEmeralds(20, Shoal.FILLED_MAP_TREASURED_FISH, 1, 24, 2));
            }
            case 5 ->
            {
