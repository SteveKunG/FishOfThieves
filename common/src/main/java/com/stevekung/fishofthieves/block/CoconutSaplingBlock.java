...
public class CoconutSaplingBlock extends SaplingBlock
{
    ...
    private final AbstractTreeGrower oldCoconutTree;

    public CoconutSaplingBlock(AbstractTreeGrower treeGrower, AbstractTreeGrower oldCoconutTree, BlockBehaviour.Properties properties)
    {
