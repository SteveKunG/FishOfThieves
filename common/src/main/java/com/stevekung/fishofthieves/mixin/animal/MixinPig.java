...
public class MixinPig
{
    ...
    {
        return FOOD_ITEMS = Ingredient.of(ObjectArrays.concat(FOOD_ITEMS.getItems(), Ingredient.of(FOTItems.BANANA, FOTBlocks.BANANA_BLOSSOM).getItems(), ItemStack.class));
    }
}