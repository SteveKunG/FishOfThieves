...
{
    @WrapOperation(method = "moveFromInventoryToPaymentSlot", at = @At(value = "INVOKE", target = "net/minecraft/world/item/ItemStack.isSameItemSameComponents(Lnet/minecraft/world/item/ItemStack;Lnet/minecraft/world/item/ItemStack;)Z"))
