...
public record DebugCenterPosStructureInfo(List<StructurePos> structurePosList)
{
    ...
    public record StructurePos(BlockPos blockPos, Identifier identifier)
    {
        public static final StreamCodec<FriendlyByteBuf, StructurePos> STREAM_CODEC = StreamCodec.composite(BlockPos.STREAM_CODEC, StructurePos::blockPos, Identifier.STREAM_CODEC, StructurePos::identifier, StructurePos::new);
    }
}
