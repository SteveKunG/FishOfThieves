...
public class BattlegillModel<T extends Battlegill> extends EntityModel<T> implements HeadphoneModel.Scaleable<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        var head = main.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -5.5F, -3.55F, 0.1745F, 0.0F, 0.0F));
