...
public class WildsplashModel<S extends ThievesFishRenderState> extends EntityModel<S> implements HeadphoneModel.Scaleable<S>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        var body_main = main.addOrReplaceChild("body_main", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -1.5F, -3.0F, 5.0F, 5.0F, 6.0F, new CubeDeformation(0.01F)).texOffs(22, 1).addBox(0.0F, -2.5F, -2.0F, 0.0F, 1.0F, 5.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -6.0F, -2.0F));
        ...
        var body_back = main.addOrReplaceChild("body_back", CubeListBuilder.create().texOffs(20, 21).addBox(-1.5F, -1.85F, 0.0F, 3.0F, 4.0F, 3.0F, CubeDeformation.NONE).texOffs(22, 5).addBox(0.0F, -3.25F, -0.75F, 0.0F, 2.0F, 3.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -5.0F, 1.0F));
