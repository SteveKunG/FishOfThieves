...
public class WildsplashModel<T extends Wildsplash> extends EntityModel<T> implements ScaleableModel<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        var body_front = partDefinition.addOrReplaceChild("body_front", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -1.5F, -3.0F, 5.0F, 5.0F, 6.0F, new CubeDeformation(0.01F)).texOffs(20, 19).addBox(-2.5F, -0.75F, -3.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, 18.0F, -2.0F));
        ...
        body_back.addOrReplaceChild("body_back_2", CubeListBuilder.create().texOffs(17, 0).addBox(-1.0F, -1.5F, -0.5F, 2.0F, 3.0F, 2.0F).texOffs(0, -3).addBox(0.0F, -2.5F, 1.5F, 0.0F, 5.0F, 3.0F), PartPose.offset(0.0F, 0.25F, 3.0F));
