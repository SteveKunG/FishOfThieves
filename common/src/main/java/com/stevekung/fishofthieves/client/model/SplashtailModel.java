...
public class SplashtailModel<T extends Splashtail> extends EntityModel<T> implements HeadphoneModel.Scaleable<T>, ModelPartGetter
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        var body_main = main.addOrReplaceChild("body_main", CubeListBuilder.create().texOffs(0, 8).addBox(-1.5F, -6.25F, -3.5F, 3.0F, 5.0F, 6.0F, new CubeDeformation(0.01F)).texOffs(20, 14).addBox(0.0F, -8.25F, -0.5F, 0.0F, 2.0F, 3.0F, CubeDeformation.NONE).texOffs(20, 10).addBox(0.0F, -1.25F, -2.5F, 0.0F, 1.0F, 6.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        var body_back = main.addOrReplaceChild("body_back", CubeListBuilder.create().texOffs(0, 19).addBox(-1.5F, -1.75F, 0.0F, 3.0F, 4.0F, 6.0F, CubeDeformation.NONE).texOffs(16, 6).addBox(-1.5F, -2.5F, -0.25F, 3.0F, 1.0F, 5.0F, new CubeDeformation(-0.2F)).texOffs(20, 6).addBox(0.0F, -5.25F, 0.0F, 0.0F, 4.0F, 6.0F, CubeDeformation.NONE).texOffs(20, 20).addBox(0.0F, -2.25F, 6.0F, 0.0F, 5.0F, 5.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -3.5F, 2.5F));
