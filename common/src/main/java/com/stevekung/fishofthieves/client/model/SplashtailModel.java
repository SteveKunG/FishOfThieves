...
public class SplashtailModel<T extends Splashtail> extends EntityModel<T> implements ScaleableModel<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        var body_front = partDefinition.addOrReplaceChild("body_front", CubeListBuilder.create().texOffs(0, 8).addBox(-1.5F, -0.25F, -3.0F, 3.0F, 5.0F, 6.0F, new CubeDeformation(0.01F)).texOffs(11, 0).addBox(-1.5F, 0.25F, -3.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, 18.0F, -0.5F));

        body_front.addOrReplaceChild("fin_back_1", CubeListBuilder.create().texOffs(20, 14).addBox(0.0F, 1.25F, 0.0F, 0.0F, 2.0F, 3.0F), PartPose.offset(0.0F, -3.5F, 0.0F));

        body_front.addOrReplaceChild("right_fin", CubeListBuilder.create().texOffs(20, 22).addBox(-3.0F, 0.75F, 0.0F, 3.0F, 3.0F, 0.0F), PartPose.offsetAndRotation(-1.0F, 1.0F, -2.0F, 0.0F, 0.7854F, 0.0F));

        body_front.addOrReplaceChild("left_fin", CubeListBuilder.create().texOffs(20, 19).addBox(0.0F, 0.75F, 0.0F, 3.0F, 3.0F, 0.0F), PartPose.offsetAndRotation(1.0F, 1.0F, -2.0F, 0.0F, -0.7854F, 0.0F));
        ...
        var body_back = partDefinition.addOrReplaceChild("body_back", CubeListBuilder.create().texOffs(16, 6).addBox(-1.5F, -2.5F, -0.25F, 3.0F, 1.0F, 5.0F, new CubeDeformation(-0.2F)).texOffs(0, 19).addBox(-1.5F, -1.75F, 0.0F, 3.0F, 4.0F, 6.0F), PartPose.offset(0.0F, 20.5F, 2.5F));
        ...
        head.addOrReplaceChild("head_r2", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -2.25F, -4.25F, 3.0F, 3.0F, 5.0F), PartPose.offsetAndRotation(0.0F, 2.25F, -0.5F, 0.0873F, 0.0F, 0.0F));
