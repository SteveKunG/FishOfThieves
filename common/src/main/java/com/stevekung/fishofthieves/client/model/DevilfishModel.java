...
public class DevilfishModel<T extends Devilfish> extends EntityModel<T> implements HeadphoneModel.Scaleable<T>, ModelPartGetter
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        var head = main.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.0F, -5.5F, -3.5F));
        ...
        var body_main = main.addOrReplaceChild("body_main", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -3.25F, -2.25F, 4.0F, 6.0F, 5.0F, CubeDeformation.NONE).texOffs(6, 22).addBox(0.0F, -5.25F, -2.25F, 0.0F, 2.0F, 5.0F, CubeDeformation.NONE).texOffs(6, 25).addBox(0.0F, 2.75F, -1.75F, 0.0F, 2.0F, 4.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -4.75F, -1.25F));
