...
public class DevilfishModel<T extends Devilfish> extends EntityModel<T> implements ScaleableModel<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        mouth.addOrReplaceChild("mouth_r1", CubeListBuilder.create().texOffs(12, 17).addBox(-2.0F, -2.5F, -4.65F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.06F)).texOffs(12, 19).addBox(-2.0F, -2.0F, -2.3F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.06F)), PartPose.offsetAndRotation(0.0F, 1.5F, -0.1F, -0.6109F, 0.0F, 0.0F));
