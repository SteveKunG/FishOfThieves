...
public class DevilfishModel<T extends Devilfish> extends EntityModel<T> implements ScaleableModel<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        mouth.addOrReplaceChild("head_r3", CubeListBuilder.create().texOffs(12, 19).addBox(-6.09F, -1.8547F, -2.3224F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.06F)).texOffs(12, 17).addBox(-6.09F, -2.3547F, -4.8503F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.06F)), PartPose.offsetAndRotation(4.08F, 1.0936F, -0.1075F, -0.6109F, 0.0F, 0.0F));
