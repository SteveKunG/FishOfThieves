...
public class StormfishModel<S extends ThievesFishRenderState> extends EntityModel<S> implements HeadphoneModel.Scaleable<S>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        var head = main.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 13).addBox(-1.0F, -7.25F, -6.0F, 2.0F, 6.0F, 4.0F, new CubeDeformation(0.01F)).texOffs(40, -3).addBox(0.0F, -12.25F, -6.0F, 0.0F, 5.0F, 3.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 4.5F, -1.0F));
        ...
        var body_main = main.addOrReplaceChild("body_main", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -7.25F, -3.0F, 3.0F, 6.0F, 7.0F, new CubeDeformation(0.1F)).texOffs(20, 3).addBox(0.0F, -11.25F, -3.0F, 0.0F, 4.0F, 7.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 4.5F, -1.0F));
        ...
        var body_back = main.addOrReplaceChild("body_back", CubeListBuilder.create().texOffs(0, 23).addBox(-1.0F, -2.5F, 0.0F, 2.0F, 5.0F, 4.0F, CubeDeformation.NONE).texOffs(40, 4).addBox(0.0F, -5.5F, 0.0F, 0.0F, 3.0F, 2.0F, CubeDeformation.NONE).texOffs(40, 9).addBox(0.0F, 2.5F, 1.0F, 0.0F, 3.0F, 2.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 0.0F, 3.0F));
