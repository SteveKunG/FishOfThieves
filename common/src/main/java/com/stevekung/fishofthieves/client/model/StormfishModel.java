...
public class StormfishModel<T extends Stormfish> extends EntityModel<T> implements ScaleableModel<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        body_back.addOrReplaceChild("body_back_2", CubeListBuilder.create().texOffs(32, -4).addBox(0.0F, -4.5F, 2.9F, 0.0F, 9.0F, 4.0F).texOffs(13, 23).addBox(-1.0F, -1.5F, -0.1F, 2.0F, 3.0F, 3.0F), PartPose.offset(0.0F, 0.0F, 4.0F));
