...
public class WreckerModel<T extends Wrecker> extends EntityModel<T> implements ScaleableModel<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        head.addOrReplaceChild("eyes_r1", CubeListBuilder.create().texOffs(14, 0).addBox(-3.0F, -1.7F, 0.1F, 6.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)).texOffs(15, 2).addBox(-2.5F, -1.5F, 0.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.15F)), PartPose.offsetAndRotation(0.0F, 0.0868F, 0.4924F, -0.1745F, 0.0F, 0.0F));

        head.addOrReplaceChild("bulb", CubeListBuilder.create().texOffs(18, 1).addBox(-0.02F, -4.0881F, -2.448F, 0.0F, 5.0F, 3.0F).texOffs(27, 19).addBox(-0.52F, -3.0881F, -3.448F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.02F, -1.9679F, 0.9558F, 0.3054F, 0.0F, 0.0F));
