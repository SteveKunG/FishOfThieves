...
public class WreckerModel<T extends Wrecker> extends EntityModel<T> implements HeadphoneModel.Scaleable<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        var head = main.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 0.0F, -3.55F, 0.1745F, 0.0F, 0.0F));
        ...
        var body_main = main.addOrReplaceChild("body_main", CubeListBuilder.create().texOffs(0, 9).addBox(-2.5F, -6.9F, -2.5F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.01F)).texOffs(20, 21).addBox(0.0F, -9.9F, -1.5F, 0.0F, 3.0F, 3.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 4.5F, 0.0F));
        ...
        var body_back = main.addOrReplaceChild("body_back", CubeListBuilder.create().texOffs(18, 10).addBox(-1.5F, -2.0F, -1.0F, 3.0F, 4.0F, 4.0F, CubeDeformation.NONE).texOffs(20, 25).addBox(0.0F, -5.0F, 0.0F, 0.0F, 3.0F, 3.0F, CubeDeformation.NONE).texOffs(20, 15).addBox(0.0F, -2.5F, 3.0F, 0.0F, 5.0F, 3.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 0.0F, 1.5F));
