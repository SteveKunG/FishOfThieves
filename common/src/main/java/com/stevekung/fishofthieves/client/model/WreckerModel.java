...
public class WreckerModel<T extends Wrecker> extends EntityModel<T> implements ScaleableModel<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        mouth.addOrReplaceChild("mouth_r1", CubeListBuilder.create().texOffs(0, 25).addBox(0.0F, -2.0F, 0.0F, 0.0F, 2.0F, 5.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(-2.7F, -4.5F, -2.75F, -1.0472F, -0.1134F, -0.0654F));
        mouth.addOrReplaceChild("mouth_r2", CubeListBuilder.create().texOffs(0, 25).addBox(0.0F, -2.0F, 0.0F, 0.0F, 2.0F, 5.0F, CubeDeformation.NONE), PartPose.offsetAndRotation(2.7F, -4.5F, -2.75F, -1.0472F, 0.1134F, 0.0654F));
        ...
        mouth.addOrReplaceChild("mouth_r4", CubeListBuilder.create().texOffs(0, 24).addBox(-2.5F, 0.2F, -4.85F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.0F, -0.35F, -0.25F, -1.0472F, 0.0F, 0.0F));
