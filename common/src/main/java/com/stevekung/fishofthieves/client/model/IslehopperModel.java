...
public class IslehopperModel<S extends ThievesFishRenderState> extends EntityModel<S> implements HeadphoneModel.Scaleable<S>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        var body_back = main.addOrReplaceChild("body_back", CubeListBuilder.create().texOffs(18, 4).addBox(-1.5F, -2.0F, 0.0F, 3.0F, 4.0F, 2.0F, CubeDeformation.NONE), PartPose.offset(0.0F, -3.75F, 1.5F));
