...
public class IslehopperModel<T extends Islehopper> extends EntityModel<T> implements ScaleableModel<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        var body_front = partDefinition.addOrReplaceChild("body_front", CubeListBuilder.create().texOffs(0, 14).addBox(0.0F, -1.0F, -3.5F, 0.0F, 1.0F, 5.0F).texOffs(0, 17).addBox(0.0F, 5.0F, -3.5F, 0.0F, 1.0F, 5.0F).texOffs(0, 0).addBox(-2.0F, 0.0F, -3.5F, 4.0F, 5.0F, 5.0F).texOffs(18, 0).addBox(-2.5F, 0.75F, -3.75F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, 18.0F, 0.0F));
