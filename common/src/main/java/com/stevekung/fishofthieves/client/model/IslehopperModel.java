...
public class IslehopperModel<T extends Islehopper> extends EntityModel<T> implements ScaleableModel<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(18, 10).addBox(-2.0F, -3.25F, -0.75F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(0.0F, -1.0F, -2.5F, 1.1781F, 0.0F, 0.0F));
        head.addOrReplaceChild("head_r2", CubeListBuilder.create().texOffs(0, 10).addBox(-2.0F, -2.3F, 0.45F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.02F)), PartPose.offsetAndRotation(0.0F, -1.0F, -3.5F, 1.0908F, 0.0F, 0.0F));
        var body_main = partDefinition.addOrReplaceChild("body_main", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -6.0F, -3.5F, 4.0F, 5.0F, 5.0F, CubeDeformation.NONE).texOffs(18, 0).addBox(-2.5F, -5.25F, -3.75F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.01F)).texOffs(0, 14).addBox(0.0F, -7.0F, -3.5F, 0.0F, 1.0F, 5.0F, CubeDeformation.NONE).texOffs(0, 17).addBox(0.0F, -1.0F, -3.5F, 0.0F, 1.0F, 5.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 24.0F, 0.0F));
