...
public class PondieModel<S extends ThievesFishRenderState> extends EntityModel<S> implements HeadphoneModel.Scaleable<S>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        var main = partDefinition.addOrReplaceChild("main", CubeListBuilder.create(), PartPose.offset(0.0F, 20.0F, 0.0F));
        ...
        var body_main = main.addOrReplaceChild("body_main", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -7.0F, -2.5F, 5.0F, 6.0F, 5.0F, CubeDeformation.NONE).texOffs(15, 0).addBox(-2.5F, -2.0F, -3.5F, 5.0F, 1.0F, 1.0F, CubeDeformation.NONE).texOffs(18, 18).addBox(0.0F, -8.5F, -2.0F, 0.0F, 2.0F, 4.0F, CubeDeformation.NONE).texOffs(15, 1).addBox(0.0F, -1.0F, -2.0F, 0.0F, 1.0F, 3.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 4.0F, 0.0F));
