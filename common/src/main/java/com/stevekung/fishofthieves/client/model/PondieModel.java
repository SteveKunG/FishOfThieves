...
public class PondieModel<T extends Pondie> extends EntityModel<T> implements ScaleableModel<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        var body_front = partDefinition.addOrReplaceChild("body_front", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -1.0F, 0.0F, 5.0F, 6.0F, 5.0F).texOffs(15, 0).addBox(-2.5F, 4.0F, -1.0F, 5.0F, 1.0F, 1.0F).texOffs(15, 2).addBox(-2.5F, -0.25F, 0.75F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, 18.0F, -2.5F));
        ...
        var body_back = partDefinition.addOrReplaceChild("body_back", CubeListBuilder.create().texOffs(20, 10).addBox(-1.0F, -1.5F, 1.5F, 2.0F, 3.0F, 2.0F).texOffs(20, 4).addBox(-1.5F, -2.0F, 0.0F, 3.0F, 4.0F, 2.0F), PartPose.offset(0.0F, 19.5F, 2.5F));
