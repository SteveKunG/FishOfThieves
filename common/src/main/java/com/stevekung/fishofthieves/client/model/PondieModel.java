...
public class PondieModel<T extends Pondie> extends EntityModel<T> implements ScaleableModel<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(0, 11).addBox(-2.5F, -2.2F, -2.3F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(0.0F, -4.25F, -3.0F, 0.48F, 0.0F, 0.0F));
