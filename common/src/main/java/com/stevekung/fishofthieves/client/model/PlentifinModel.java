...
public class PlentifinModel<T extends Plentifin> extends EntityModel<T> implements ScaleableModel<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        var body_front = partDefinition.addOrReplaceChild("body_front", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.6862F, -2.5135F, 2.0F, 6.0F, 5.0F).texOffs(17, 14).addBox(-1.0F, 0.5F, -1.75F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, 20.6F, -2.0F));
