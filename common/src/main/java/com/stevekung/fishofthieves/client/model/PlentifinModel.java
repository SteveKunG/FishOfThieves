...
public class PlentifinModel<T extends Plentifin> extends EntityModel<T> implements HeadphoneModel.Scaleable<T>
{
    ...
    public static LayerDefinition createBodyLayer()
    {
        ...
        var main = partDefinition.addOrReplaceChild("main", CubeListBuilder.create(), PartPose.offset(0.0F, 20.5F, 0.0F));
        ...
        var body_main = main.addOrReplaceChild("body_main", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -6.1F, -4.5F, 2.0F, 6.0F, 5.0F, CubeDeformation.NONE).texOffs(0, 7).addBox(0.0F, -8.65F, -3.5F, 0.0F, 3.0F, 4.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 3.5F, 0.0F));
        ...
        var body_back = main.addOrReplaceChild("body_back", CubeListBuilder.create().texOffs(14, 8).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 4.0F, 2.0F, CubeDeformation.NONE).texOffs(1, 11).addBox(0.0F, -5.15F, 0.0F, 0.0F, 4.0F, 3.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 0.0F, 0.5F));
