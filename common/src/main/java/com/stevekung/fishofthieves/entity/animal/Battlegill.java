...
public class Battlegill extends AbstractSchoolingThievesFish<BattlegillVariant>
{
    ...
    @Override
    public Holder<BattlegillVariant> getSpawnVariant(boolean creativeBucket)
    {
        return this.getSpawnVariant(this, FOTTags.FishVariant.DEFAULT_BATTLEGILL_SPAWNS, BattlegillVariants.JADE, creativeBucket);
    }
