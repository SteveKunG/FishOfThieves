...
{
    public static final Codec<SplashtailVariant> DIRECT_CODEC = RecordCodecBuilder.create(instance -> AbstractFishVariant.commonFields(instance).apply(instance, SplashtailVariant::new));
