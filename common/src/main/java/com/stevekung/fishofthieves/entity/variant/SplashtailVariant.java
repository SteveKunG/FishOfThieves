...
public record SplashtailVariant(String name, ClientAsset texture, Optional<ClientAsset> glowTexture, SpawnSettings spawnSettings, int customModelData) implements AbstractFishVariant
{
    ...
    public SplashtailVariant(String name, ClientAsset texture, Optional<ClientAsset> glowTexture, int customModelData)
    {
