...
{
    private DevilfishVariant(Supplier<Predicate<SpawnConditionContext>> condition, ResourceLocation texture, ResourceLocation glowTexture, Boolean isTreasured)
    {
    ...
    public static class Builder
    {
        ...
        {
            return new DevilfishVariant(() -> this.condition, this.texture, this.glowTexture, this.isTreasured);
        }
