...
{
    private WreckerVariant(Supplier<Predicate<SpawnConditionContext>> condition, ResourceLocation texture, ResourceLocation glowTexture, Boolean isTreasured)
    {
    ...
    public static class Builder
    {
        ...
        {
            return new WreckerVariant(() -> this.condition, this.texture, this.glowTexture, this.isTreasured);
        }

        private ResourceLocation createTexture(String name)
        {
            return FishOfThieves.id("textures/entity/wrecker/%s.png".formatted(name));
        }
    }
}