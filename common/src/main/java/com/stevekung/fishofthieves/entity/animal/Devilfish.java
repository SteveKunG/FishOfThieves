...
public class Devilfish extends AbstractSchoolingThievesFish<DevilfishVariant>
{
    ...
    @Override
    public Holder<DevilfishVariant> getSpawnVariant(boolean creativeBucket)
    {
        return this.getSpawnVariant(this, FOTTags.FishVariant.DEFAULT_DEVILFISH_SPAWNS, DevilfishVariants.ASHEN, creativeBucket);
    }
