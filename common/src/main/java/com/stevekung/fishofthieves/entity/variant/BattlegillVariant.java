...
public record BattlegillVariant(String name, ClientAsset texture, Optional<ClientAsset> glowTexture, SpawnSettings spawnSettings, int customModelData) implements AbstractFishVariant
{
    ...
    public BattlegillVariant(String name, ClientAsset texture, Optional<ClientAsset> glowTexture, int customModelData)
    {
