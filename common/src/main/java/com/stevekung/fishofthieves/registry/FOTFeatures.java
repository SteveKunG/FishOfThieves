...
public class FOTFeatures
{
    ...
    public static final ResourceKey<Feature> COCONUT_TREE = createKey("coconut_tree");
    public static final ResourceKey<Feature> OLD_COCONUT_TREE = createKey("old_coconut_tree");
    public static final ResourceKey<Feature> BANANA_TREE = createKey("banana_tree");
    public static final ResourceKey<Feature> MANGO_TREE = createKey("mango_tree");
    public static final ResourceKey<Feature> MANGO_TREE_BEES_02 = createKey("mango_tree_bees_02");
    public static final ResourceKey<Feature> MANGO_TREE_LEAF_LITTER = createKey("mango_tree_leaf_litter");
    public static final ResourceKey<Feature> MANGO_TREE_BEES_02_LEAF_LITTER = createKey("mango_tree_bees_02_leaf_litter");

    public static final ResourceKey<Feature> TROPICAL_FLOWER = createKey("tropical_flower");
    public static final ResourceKey<Feature> TREES_TROPICAL_ISLAND = createKey("trees_tropical_island");
    public static final ResourceKey<Feature> WILD_PINEAPPLE = createKey("wild_pineapple");
    public static final ResourceKey<Feature> TALL_WILD_PINEAPPLE = createKey("tall_wild_pineapple");
    public static final ResourceKey<Feature> PATCH_WILD_PINEAPPLE = createKey("patch_wild_pineapple");
    public static final ResourceKey<Feature> PATCH_TROPICAL_MELON = createKey("patch_tropical_melon");
    public static final ResourceKey<Feature> TREES_COCONUT = createKey("trees_coconut");
    public static final ResourceKey<Feature> WILD_POMEGRANATE = createKey("wild_pomegranate");
    public static final ResourceKey<Feature> TALL_WILD_POMEGRANATE = createKey("tall_wild_pomegranate");
    public static final ResourceKey<Feature> PATCH_WILD_POMEGRANATE = createKey("patch_wild_pomegranate");
    public static final ResourceKey<Feature> PATCH_TROPICAL_BUSH = createKey("patch_tropical_bush");
    public static final ResourceKey<Feature> TROPICAL_ISLAND_ROCK = createKey("tropical_island_rock");

    public static final ResourceKey<Feature> SPARSE_JUNGLE_FRUIT_TREES = createKey("sparse_jungle_fruit_trees");
    public static final ResourceKey<Feature> SPARSE_JUNGLE_PATCH_WILD_PINEAPPLE = createKey("sparse_jungle_patch_wild_pineapple");
    public static final ResourceKey<Feature> SPARSE_JUNGLE_PATCH_WILD_POMEGRANATE = createKey("sparse_jungle_patch_wild_pomegranate");
    ...
    public static void bootstrap(BootstrapContext<Feature> context)
    {
        ...
        context.register(MANGO_TREE_BEES_02_LEAF_LITTER, createMangoTree(0.2F, leafLitters, belowTrunkProvider).build());

        context.register(TREES_TROPICAL_ISLAND, new RandomSelectorFeature(List.of(
        ...
        context.register(TROPICAL_FLOWER, new SimpleBlockFeature(new WeightedStateProvider(WeightedList.<BlockState>builder()
        ...
        context.register(WILD_PINEAPPLE, new SimpleBlockFeature(new WeightedStateProvider(WeightedList.<BlockState>builder()
        ...
        context.register(WILD_POMEGRANATE, new SimpleBlockFeature(new WeightedStateProvider(WeightedList.<BlockState>builder()
        ...
        context.register(PATCH_TROPICAL_BUSH, new SimpleBlockFeature(
        ...
        context.register(SPARSE_JUNGLE_PATCH_WILD_PINEAPPLE, new SimpleRandomSelectorFeature(HolderSet.direct(
                placedFeature.getOrThrow(FOTPlacements.TALL_WILD_PINEAPPLE),
                placedFeature.getOrThrow(FOTPlacements.WILD_PINEAPPLE))));
        context.register(SPARSE_JUNGLE_PATCH_WILD_POMEGRANATE, new SimpleRandomSelectorFeature(HolderSet.direct(
    ...
    {
        return ResourceKey.create(Registries.FEATURE, FishOfThieves.id(name));
    }
}