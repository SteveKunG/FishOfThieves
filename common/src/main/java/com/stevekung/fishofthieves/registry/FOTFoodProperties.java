...
{
    public static final FoodProperties WORMS = new FoodProperties.Builder().nutrition(1).saturationModifier(0.1f).fast().effect(new MobEffectInstance(MobEffects.CONFUSION, 400), 0.5F).build();
    ...
    public static final FoodProperties DEVILFISH = new FoodProperties.Builder().nutrition(2).saturationModifier(0.1f).effect(new MobEffectInstance(MobEffects.WEAKNESS, 200), 0.05F).build();
    ...
    public static final FoodProperties COOKED_PLENTIFIN = new FoodProperties.Builder().nutrition(5).saturationModifier(0.55f).effect(new MobEffectInstance(MobEffects.LUCK, 200), 0.1F).build();
    ...
    public static final FoodProperties COOKED_BATTLEGILL = new FoodProperties.Builder().nutrition(6).saturationModifier(0.6f).effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 200), 0.1F).build();
    ...
    public static final FoodProperties RAW_MANGO = new FoodProperties.Builder().nutrition(2).saturationModifier(0.2f)
    ...
    public static final FoodProperties GUARDIAN_FRUIT = new FoodProperties.Builder().nutrition(6).saturationModifier(1.2f)
            .alwaysEdible()
            .effect(new MobEffectInstance(FOTMobEffects.GUARDIAN_STIFLE, 3600), 0.8f)
            .build();
}