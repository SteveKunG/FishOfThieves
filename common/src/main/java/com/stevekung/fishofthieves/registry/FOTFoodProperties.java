...
public class FOTFoodProperties
{
    ...
    public static final FoodProperties COCONUT = new FoodProperties.Builder().nutrition(3).saturationMod(0.1f).build();
    ...
    public static final FoodProperties HALF_PINEAPPLE = new FoodProperties.Builder().nutrition(6).saturationMod(1.0f).build();
    public static final FoodProperties MANGO = new FoodProperties.Builder().nutrition(6).saturationMod(0.3f).build();
    public static final FoodProperties RAW_MANGO = new FoodProperties.Builder().nutrition(2).saturationMod(0.2f)
            ...
            .build();
    public static final FoodProperties POMEGRANATE = new FoodProperties.Builder().nutrition(4).saturationMod(0.2f).build();
    public static final FoodProperties GUARDIAN_FRUIT = new FoodProperties.Builder().nutrition(6).saturationMod(1.2f)
            .alwaysEat()
