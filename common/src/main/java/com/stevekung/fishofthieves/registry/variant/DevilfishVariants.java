...
public class DevilfishVariants
{
    ...
    public static final DevilfishVariant LEOPARD = DevilfishVariant.builder().condition(SpawnSelectors.never()).texture("treasured/leopard").glowTexture("treasured/leopard_glow").treasured().build();
    ...
    {
        Registry.register(FOTRegistry.DEVILFISH_VARIANT, FishOfThieves.id(key), variant);
    }
}