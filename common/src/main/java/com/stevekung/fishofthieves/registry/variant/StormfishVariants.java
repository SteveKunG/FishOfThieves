...
public class StormfishVariants
{
    ...
    public static final StormfishVariant STARSHINE = StormfishVariant.builder().condition(SpawnSelectors.never()).texture("treasured/starshine").glowTexture("treasured/starshine_glow").treasured().build();
    ...
    public static void init()
    {
        ...
        register("starshine", StormfishVariants.STARSHINE);
    }
