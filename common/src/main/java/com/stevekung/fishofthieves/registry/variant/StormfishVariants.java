...
public class StormfishVariants
{
    ...
    public static final StormfishVariant STARSHINE = StormfishVariant.builder().condition(SpawnSelectors.never()).texture("starshine").glowTexture("starshine_glow").treasured().build();
