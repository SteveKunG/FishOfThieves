...
public class SplashtailVariants
{
    ...
    public static final SplashtailVariant OBSIDIAN = SplashtailVariant.builder().condition(SpawnSelectors.never()).texture("treasured/obsidian").glowTexture("treasured/obsidian_glow").treasured().build();
    ...
    public static void init()
    {
        ...
        register("obsidian", SplashtailVariants.OBSIDIAN);
    }

    private static void register(String key, SplashtailVariant variant)
    {
        Registry.register(FOTRegistry.SPLASHTAIL_VARIANT, FishOfThieves.id(key), variant);
    }
}