...
public interface FOTTags
{
    interface Items
    {
        TagKey<Item> THIEVES_FISH_BUCKET = TagKey.create(Registries.ITEM, new ResourceLocation(FishOfThieves.MOD_ID, "thieves_fish_bucket"));
        TagKey<Item> THIEVES_FISH = TagKey.create(Registries.ITEM, new ResourceLocation(FishOfThieves.MOD_ID, "thieves_fish"));
        TagKey<Item> COOKED_THIEVES_FISH = TagKey.create(Registries.ITEM, new ResourceLocation(FishOfThieves.MOD_ID, "cooked_thieves_fish"));
        TagKey<Item> WORMS = TagKey.create(Registries.ITEM, new ResourceLocation(FishOfThieves.MOD_ID, "worms"));
    ...
    interface Blocks
    {
        TagKey<Block> FIRELIGHT_DEVILFISH_WARM_BLOCKS = TagKey.create(Registries.BLOCK, new ResourceLocation(FishOfThieves.MOD_ID, "firelight_devilfish_warm_blocks"));
        TagKey<Block> CORAL_WILDSPLASH_SPAWNABLE_ON = TagKey.create(Registries.BLOCK, new ResourceLocation(FishOfThieves.MOD_ID, "coral_wildsplash_spawnable_on"));
        TagKey<Block> EARTHWORMS_DROPS = TagKey.create(Registries.BLOCK, new ResourceLocation(FishOfThieves.MOD_ID, "earthworms_drops"));
    ...
    {
        TagKey<Structure> BONE_ANCIENTSCALES_SPAWN_IN = TagKey.create(Registries.STRUCTURE, new ResourceLocation(FishOfThieves.MOD_ID, "bone_ancientscales_spawn_in"));
        TagKey<Structure> BONEDUST_PLENTIFINS_SPAWN_IN = TagKey.create(Registries.STRUCTURE, new ResourceLocation(FishOfThieves.MOD_ID, "bonedust_plentifins_spawn_in"));
        TagKey<Structure> BATTLEGILLS_SPAWN_IN = TagKey.create(Registries.STRUCTURE, new ResourceLocation(FishOfThieves.MOD_ID, "battlegills_spawn_in"));
        TagKey<Structure> ANCIENTSCALES_SPAWN_IN = TagKey.create(Registries.STRUCTURE, new ResourceLocation(FishOfThieves.MOD_ID, "ancientscales_spawn_in"));
        TagKey<Structure> PLENTIFINS_SPAWN_IN = TagKey.create(Registries.STRUCTURE, new ResourceLocation(FishOfThieves.MOD_ID, "plentifins_spawn_in"));
        TagKey<Structure> WRECKERS_SPAWN_IN = TagKey.create(Registries.STRUCTURE, new ResourceLocation(FishOfThieves.MOD_ID, "wreckers_spawn_in"));
        TagKey<Structure> WRECKERS_LOCATED = TagKey.create(Registries.STRUCTURE, new ResourceLocation(FishOfThieves.MOD_ID, "wreckers_located"));
    }

    interface Biomes
    {
        TagKey<Biome> SPAWNS_SPLASHTAILS = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_splashtails"));
        TagKey<Biome> SPAWNS_PONDIES = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_pondies"));
        TagKey<Biome> SPAWNS_ISLEHOPPERS = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_islehoppers"));
        TagKey<Biome> SPAWNS_ANCIENTSCALES = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_ancientscales"));
        TagKey<Biome> SPAWNS_PLENTIFINS = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_plentifins"));
        TagKey<Biome> SPAWNS_WILDSPLASH = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_wildsplash"));
        TagKey<Biome> SPAWNS_DEVILFISH = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_devilfish"));
        TagKey<Biome> SPAWNS_BATTLEGILLS = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_battlegills"));
        TagKey<Biome> SPAWNS_WRECKERS = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_wreckers"));
        TagKey<Biome> SPAWNS_STORMFISH = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_stormfish"));
        TagKey<Biome> DEVILFISH_CANNOT_SPAWN = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "devilfish_cannot_spawn"));
        TagKey<Biome> SPAWNS_SAND_BATTLEGILLS = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_sand_battlegills"));
        TagKey<Biome> SPAWNS_MOSS_ISLEHOPPERS = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_moss_islehoppers"));
        TagKey<Biome> SPAWNS_WILD_STORMFISH = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_wild_stormfish"));
        TagKey<Biome> SPAWNS_CORAL_WILDSPLASH = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_coral_wildsplash"));
        TagKey<Biome> SPAWNS_SNOW_WRECKERS = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_snow_wreckers"));
        TagKey<Biome> SPAWNS_SANDY_WILDSPLASH = TagKey.create(Registries.BIOME, new ResourceLocation(FishOfThieves.MOD_ID, "spawns_sandy_wildsplash"));
