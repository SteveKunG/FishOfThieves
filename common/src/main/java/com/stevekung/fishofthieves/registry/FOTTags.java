...
public class FOTTags
{
    ...
    public static final TagKey<EntityType<?>> BONE_FISH_DROP = TagKey.create(Registry.ENTITY_TYPE_REGISTRY, new ResourceLocation(FishOfThieves.MOD_ID, "bone_fish_drop"));
