...
public class FOTMemoryModuleTypes
{
    ...
    public static final MemoryModuleType<Integer> BREACHED_TICK = register("breached_tick", new MemoryModuleType<>(Optional.of(Codec.INT)));
    public static final MemoryModuleType<Integer> FOLLOW_WITH_EFFECT_COOLDOWN_TICKS = register("follow_with_effect_cooldown_ticks", new MemoryModuleType<>(Optional.of(Codec.INT)));
    ...
    public static final MemoryModuleType<Boolean> IS_EFFECT_FOLLOWER = register("is_effect_follower", new MemoryModuleType<>(Optional.of(Codec.BOOL)));
