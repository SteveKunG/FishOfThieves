...
{
    public static final Holder<MapDecorationType> TREASURED_FISH = register("treasured_fish", "treasured_fish", true, false);
    ...
    private static Holder<MapDecorationType> register(String name, String assetId, boolean showOnItemFrame, boolean trackCount)
    {
        ...
        var mapDecorationType = new MapDecorationType(FishOfThieves.id(assetId), showOnItemFrame, trackCount);
