...
public class IslehopperVariants
{
    ...
    public static void bootstrap(BootstrapContext<IslehopperVariant> context)
    {
        ...
        registerContext.register(context, RAVEN, "raven", 3, AllOfCondition.allOf(ProbabilityCondition.defaultRareProbablity(), HeightCondition.height(Optional.empty(), Optional.of(0))).build());
