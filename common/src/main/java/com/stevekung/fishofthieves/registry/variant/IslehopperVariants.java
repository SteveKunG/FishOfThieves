...
public class IslehopperVariants
{
    ...
    public static final IslehopperVariant HONEY = IslehopperVariant.builder().condition(SpawnSelectors.simpleSpawn(context ->
    {
        ...
        var optional = poiManager.findClosest(type -> type.is(PoiTypes.BEEHIVE) || type.is(PoiTypes.BEE_NEST), context.blockPos(), 12, PoiManager.Occupancy.ANY);
    ...
    public static void init()
    {
        ...
        register("briny", IslehopperVariants.BRINY);
    }
