...
{
    public static final LootItemConditionType LOCATION_CHECK = new LootItemConditionType(new FOTLocationCheck.Serializer());
    ...
    public static final LootItemCondition.Builder IN_SHIPWRECKS_OR_RUINED_PORTAL_OCEAN = FOTLocationCheck.checkLocation(FOTLocationPredicate.Builder.location().setStructureInRange(FOTTags.Structures.WRECKERS_SPAWN_IN, 32, 1));
    ...
    {
        register("location_check", LOCATION_CHECK);
