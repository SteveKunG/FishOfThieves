...
public class FOTLootItemConditions
{
    ...
    public static final LootItemCondition.Builder IN_SHIPWRECKS_OR_RUINED_PORTAL_OCEAN = FOTLocationCheck.checkLocation(FOTLocationPredicate.Builder.location().setStructureInRange(FOTTags.Structures.WRECKERS_SPAWN_IN, 12));
