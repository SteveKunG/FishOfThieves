...
public class FOTDecoratedPotPatterns
{
    ...
    public static final ResourceKey<String> GREAT_MOUTH = create(GREAT_MOUTH_NAME);
    ...
    {
        Registry.register(BuiltInRegistries.DECORATED_POT_PATTERNS, FishOfThieves.id(key), key);
    }
