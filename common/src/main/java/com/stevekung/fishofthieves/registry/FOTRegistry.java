...
{
    public static final ResourceKey<Registry<SplashtailVariant>> SPLASHTAIL_VARIANT_REGISTRY = Registry.createRegistryKey("splashtail_variant");
    ...
    public static final ResourceKey<Registry<PondieVariant>> PONDIE_VARIANT_REGISTRY = Registry.createRegistryKey("pondie_variant");
    ...
    public static final ResourceKey<Registry<IslehopperVariant>> ISLEHOPPER_VARIANT_REGISTRY = Registry.createRegistryKey("islehopper_variant");
    ...
    public static final ResourceKey<Registry<AncientscaleVariant>> ANCIENTSCALE_VARIANT_REGISTRY = Registry.createRegistryKey("ancientscale_variant");
    ...
    public static final ResourceKey<Registry<PlentifinVariant>> PLENTIFIN_VARIANT_REGISTRY = Registry.createRegistryKey("plentifin_variant");
    ...
    public static final ResourceKey<Registry<WildsplashVariant>> WILDSPLASH_VARIANT_REGISTRY = Registry.createRegistryKey("wildsplash_variant");
    ...
    public static final ResourceKey<Registry<DevilfishVariant>> DEVILFISH_VARIANT_REGISTRY = Registry.createRegistryKey("devilfish_variant");
    ...
    public static final ResourceKey<Registry<BattlegillVariant>> BATTLEGILL_VARIANT_REGISTRY = Registry.createRegistryKey("battlegill_variant");
    ...
    public static final ResourceKey<Registry<WreckerVariant>> WRECKER_VARIANT_REGISTRY = Registry.createRegistryKey("wrecker_variant");
    ...
    public static final ResourceKey<Registry<StormfishVariant>> STORMFISH_VARIANT_REGISTRY = Registry.createRegistryKey("stormfish_variant");
