...
public class FOTItems
{
    ...
    public static final Item GRUBS = register("grubs", properties -> new FOTWormItem(properties.food(FOTFoodProperties.WORMS, FOTConsumables.WORMS)));
    public static final Item LEECHES = register("leeches", properties -> new FOTWormItem(properties.food(FOTFoodProperties.WORMS, FOTConsumables.WORMS)));
    ...
    public static final Item SPLASHTAIL_SPAWN_EGG = register("splashtail_spawn_egg", properties -> new FOTSpawnEggItem<>(FOTEntities.SPLASHTAIL, FOTRegistries.SPLASHTAIL_VARIANT, FOTDataComponentTypes.SPLASHTAIL_VARIANT, properties));
    public static final Item PONDIE_SPAWN_EGG = register("pondie_spawn_egg", properties -> new FOTSpawnEggItem<>(FOTEntities.PONDIE, FOTRegistries.PONDIE_VARIANT, FOTDataComponentTypes.PONDIE_VARIANT, properties));
    public static final Item ISLEHOPPER_SPAWN_EGG = register("islehopper_spawn_egg", properties -> new FOTSpawnEggItem<>(FOTEntities.ISLEHOPPER, FOTRegistries.ISLEHOPPER_VARIANT, FOTDataComponentTypes.ISLEHOPPER_VARIANT, properties));
    public static final Item ANCIENTSCALE_SPAWN_EGG = register("ancientscale_spawn_egg", properties -> new FOTSpawnEggItem<>(FOTEntities.ANCIENTSCALE, FOTRegistries.ANCIENTSCALE_VARIANT, FOTDataComponentTypes.ANCIENTSCALE_VARIANT, properties));
    public static final Item PLENTIFIN_SPAWN_EGG = register("plentifin_spawn_egg", properties -> new FOTSpawnEggItem<>(FOTEntities.PLENTIFIN, FOTRegistries.PLENTIFIN_VARIANT, FOTDataComponentTypes.PLENTIFIN_VARIANT, properties));
    public static final Item WILDSPLASH_SPAWN_EGG = register("wildsplash_spawn_egg", properties -> new FOTSpawnEggItem<>(FOTEntities.WILDSPLASH, FOTRegistries.WILDSPLASH_VARIANT, FOTDataComponentTypes.WILDSPLASH_VARIANT, properties));
    public static final Item DEVILFISH_SPAWN_EGG = register("devilfish_spawn_egg", properties -> new FOTSpawnEggItem<>(FOTEntities.DEVILFISH, FOTRegistries.DEVILFISH_VARIANT, FOTDataComponentTypes.DEVILFISH_VARIANT, properties));
    public static final Item BATTLEGILL_SPAWN_EGG = register("battlegill_spawn_egg", properties -> new FOTSpawnEggItem<>(FOTEntities.BATTLEGILL, FOTRegistries.BATTLEGILL_VARIANT, FOTDataComponentTypes.BATTLEGILL_VARIANT, properties));
    public static final Item WRECKER_SPAWN_EGG = register("wrecker_spawn_egg", properties -> new FOTSpawnEggItem<>(FOTEntities.WRECKER, FOTRegistries.WRECKER_VARIANT, FOTDataComponentTypes.WRECKER_VARIANT, properties));
    public static final Item STORMFISH_SPAWN_EGG = register("stormfish_spawn_egg", properties -> new FOTSpawnEggItem<>(FOTEntities.STORMFISH, FOTRegistries.STORMFISH_VARIANT, FOTDataComponentTypes.STORMFISH_VARIANT, properties));
    ...
    public static final Item PINEAPPLE = register("pineapple", properties -> new ReturnedOnConsumeItem(properties.food(FOTFoodProperties.PINEAPPLE), () -> FOTItems.HALF_PINEAPPLE));
    public static final Item CROWNLESS_PINEAPPLE = register("crownless_pineapple", properties -> new ReturnedOnConsumeItem(properties.food(FOTFoodProperties.PINEAPPLE), () -> FOTItems.HALF_PINEAPPLE));
    ...
    public static final Item MANGO = register("mango", properties -> new ReturnedOnConsumeItem(properties.food(FOTFoodProperties.MANGO), () -> FOTItems.MANGO_PIT, 0.2f));
    public static final Item RAW_MANGO = register("raw_mango", properties -> new ReturnedOnConsumeItem(properties.food(FOTFoodProperties.RAW_MANGO, FOTConsumables.RAW_MANGO_CONSUMABLE), () -> FOTItems.MANGO_PIT, 0.2f));
    public static final Item POMEGRANATE = register("pomegranate", properties -> new ReturnedOnConsumeItem(properties.food(FOTFoodProperties.POMEGRANATE), () -> FOTItems.POMEGRANATE_SEEDS, 0.6f));
