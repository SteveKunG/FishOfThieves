...
public class FOTItems
{
    ...
    public static final Item OAK_FISH_PLAQUE = registerBlock(FOTBlocks.OAK_FISH_PLAQUE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item SPRUCE_FISH_PLAQUE = registerBlock(FOTBlocks.SPRUCE_FISH_PLAQUE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item BIRCH_FISH_PLAQUE = registerBlock(FOTBlocks.BIRCH_FISH_PLAQUE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item JUNGLE_FISH_PLAQUE = registerBlock(FOTBlocks.JUNGLE_FISH_PLAQUE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item ACACIA_FISH_PLAQUE = registerBlock(FOTBlocks.ACACIA_FISH_PLAQUE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item DARK_OAK_FISH_PLAQUE = registerBlock(FOTBlocks.DARK_OAK_FISH_PLAQUE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item MANGROVE_FISH_PLAQUE = registerBlock(FOTBlocks.MANGROVE_FISH_PLAQUE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item CHERRY_FISH_PLAQUE = registerBlock(FOTBlocks.CHERRY_FISH_PLAQUE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item PALE_OAK_FISH_PLAQUE = registerBlock(FOTBlocks.PALE_OAK_FISH_PLAQUE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item POPLAR_FISH_PLAQUE = registerBlock(FOTBlocks.POPLAR_FISH_PLAQUE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item BAMBOO_FISH_PLAQUE = registerBlock(FOTBlocks.BAMBOO_FISH_PLAQUE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item CRIMSON_FISH_PLAQUE = registerBlock(FOTBlocks.CRIMSON_FISH_PLAQUE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item WARPED_FISH_PLAQUE = registerBlock(FOTBlocks.WARPED_FISH_PLAQUE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    ...
    public static final Item SMALL_COCONUT_LOG = registerBlock(FOTBlocks.SMALL_COCONUT_LOG, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item SMALL_COCONUT_WOOD = registerBlock(FOTBlocks.SMALL_COCONUT_WOOD, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item MEDIUM_COCONUT_LOG = registerBlock(FOTBlocks.MEDIUM_COCONUT_LOG, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item MEDIUM_COCONUT_WOOD = registerBlock(FOTBlocks.MEDIUM_COCONUT_WOOD, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item COCONUT_LOG = registerBlock(FOTBlocks.COCONUT_LOG, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item COCONUT_WOOD = registerBlock(FOTBlocks.COCONUT_WOOD, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item STRIPPED_COCONUT_LOG = registerBlock(FOTBlocks.STRIPPED_COCONUT_LOG, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item STRIPPED_COCONUT_WOOD = registerBlock(FOTBlocks.STRIPPED_COCONUT_WOOD, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item STRIPPED_MEDIUM_COCONUT_LOG = registerBlock(FOTBlocks.STRIPPED_MEDIUM_COCONUT_LOG, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item STRIPPED_MEDIUM_COCONUT_WOOD = registerBlock(FOTBlocks.STRIPPED_MEDIUM_COCONUT_WOOD, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item STRIPPED_SMALL_COCONUT_LOG = registerBlock(FOTBlocks.STRIPPED_SMALL_COCONUT_LOG, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item STRIPPED_SMALL_COCONUT_WOOD = registerBlock(FOTBlocks.STRIPPED_SMALL_COCONUT_WOOD, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item COCONUT_FRONDS = registerBlock(FOTBlocks.COCONUT_FRONDS, properties -> properties.compostable(FOTContextIntProviders.COMPOSTABLE_MEDIUM_HIGH_80));
    public static final Item BANANA_STEM = registerBlock(FOTBlocks.BANANA_STEM, properties -> properties.compostable(FOTContextIntProviders.COMPOSTABLE_MEDIUM_HIGH_80).cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item BANANA_LEAVES = registerBlock(FOTBlocks.BANANA_LEAVES, properties -> properties.compostable(FOTContextIntProviders.COMPOSTABLE_MEDIUM_HIGH_80));
    public static final Item BANANA_BLOSSOM = registerBlock(FOTBlocks.BANANA_BLOSSOM, properties -> properties.compostable(ContextIntProviders.COMPOSTABLE_LOW));
    public static final Item UNDERRIPE_BANANA_CLUSTER = registerBlock(FOTBlocks.UNDERRIPE_BANANA_CLUSTER, properties -> properties.compostable(ContextIntProviders.COMPOSTABLE_LOW_MEDIUM));
    public static final Item BARELY_RIPE_BANANA_CLUSTER = registerBlock(FOTBlocks.BARELY_RIPE_BANANA_CLUSTER, properties -> properties.compostable(ContextIntProviders.COMPOSTABLE_MEDIUM_HIGH));
    public static final Item RIPE_BANANA_CLUSTER = registerBlock(FOTBlocks.RIPE_BANANA_CLUSTER, properties -> properties.compostable(ContextIntProviders.COMPOSTABLE_MEDIUM_HIGH));
    public static final Item RIPE_PINEAPPLE_BLOCK = registerBlock(FOTBlocks.RIPE_PINEAPPLE_BLOCK, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.builder(EquipmentSlot.HEAD).setSwappable(false).build()).compostable(FOTContextIntProviders.COMPOSTABLE_MEDIUM_HIGH_75));
    public static final Item CROWNLESS_RIPE_PINEAPPLE_BLOCK = registerBlock(FOTBlocks.CROWNLESS_RIPE_PINEAPPLE_BLOCK, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.builder(EquipmentSlot.HEAD).setSwappable(false).build()).compostable(FOTContextIntProviders.COMPOSTABLE_MEDIUM_70));
    public static final Item UNDERRIPE_PINEAPPLE_BLOCK = registerBlock(FOTBlocks.UNDERRIPE_PINEAPPLE_BLOCK, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.builder(EquipmentSlot.HEAD).setSwappable(false).build()).compostable(FOTContextIntProviders.COMPOSTABLE_MEDIUM_60));
    public static final Item MANGO_LEAVES = registerBlock(FOTBlocks.MANGO_LEAVES, properties -> properties.compostable(ContextIntProviders.COMPOSTABLE_LOW));
    public static final Item TALL_POMEGRANATE_PLANT = register("tall_pomegranate_plant", properties -> new DoubleHighBlockItem(FOTBlocks.TALL_POMEGRANATE_PLANT, properties.useBlockDescriptionPrefix().compostable(FOTContextIntProviders.COMPOSTABLE_LOW_40)));
    public static final Item PRISMARIZED_LOG = registerBlock(FOTBlocks.PRISMARIZED_LOG, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item BUDDING_PRISMARIZED_LOG = registerBlock(FOTBlocks.BUDDING_PRISMARIZED_LOG, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));

    public static final Item PINK_PLUMERIA = registerBlock(FOTBlocks.PINK_PLUMERIA, properties -> properties.compostable(FOTContextIntProviders.COMPOSTABLE_MEDIUM_60));
    public static final Item LIGHT_BLUE_PLUMERIA = registerBlock(FOTBlocks.LIGHT_BLUE_PLUMERIA, properties -> properties.compostable(FOTContextIntProviders.COMPOSTABLE_MEDIUM_60));
    public static final Item WHITE_PLUMERIA = registerBlock(FOTBlocks.WHITE_PLUMERIA, properties -> properties.compostable(FOTContextIntProviders.COMPOSTABLE_MEDIUM_60));
    public static final Item BANANA_SHOOTS = registerBlock(FOTBlocks.BANANA_SHOOTS, properties -> properties.compostable(FOTContextIntProviders.COMPOSTABLE_VERY_LOW_25).cookingFuel(ContextIntProviders.COOKING_TIME_DRY_PLANTS));
    public static final Item MANGO_PIT = registerBlock(FOTBlocks.MANGO_PIT, properties -> properties.useItemDescriptionPrefix().compostable(FOTContextIntProviders.COMPOSTABLE_VERY_LOW_20).cookingFuel(ContextIntProviders.COOKING_TIME_DRY_PLANTS));
    public static final Item MANGO_SAPLING = registerBlock(FOTBlocks.MANGO_SAPLING, properties -> properties.compostable(FOTContextIntProviders.COMPOSTABLE_VERY_LOW_25).cookingFuel(ContextIntProviders.COOKING_TIME_DRY_PLANTS));
    public static final Item POMEGRANATE_PLANT = registerBlock(FOTBlocks.POMEGRANATE_PLANT, properties -> properties.compostable(FOTContextIntProviders.COMPOSTABLE_VERY_LOW_25).cookingFuel(ContextIntProviders.COOKING_TIME_DRY_PLANTS));
    public static final Item TROPICAL_RED_FERN = registerBlock(FOTBlocks.TROPICAL_RED_FERN, properties -> properties.compostable(FOTContextIntProviders.COMPOSTABLE_LOW_40));
    public static final Item TROPICAL_MONSTERA = registerBlock(FOTBlocks.TROPICAL_MONSTERA, properties -> properties.compostable(ContextIntProviders.COMPOSTABLE_LOW));

    public static final Item COCONUT_PLANKS = registerBlock(FOTBlocks.COCONUT_PLANKS, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item COCONUT_BUTTON = registerBlock(FOTBlocks.COCONUT_BUTTON, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_ITEMS_EXTRA_SMALL));
    public static final Item COCONUT_FENCE = registerBlock(FOTBlocks.COCONUT_FENCE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item COCONUT_FENCE_GATE = registerBlock(FOTBlocks.COCONUT_FENCE_GATE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item COCONUT_PRESSURE_PLATE = registerBlock(FOTBlocks.COCONUT_PRESSURE_PLATE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item COCONUT_SLAB = registerBlock(FOTBlocks.COCONUT_SLAB, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item COCONUT_STAIRS = registerBlock(FOTBlocks.COCONUT_STAIRS, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item COCONUT_TRAPDOOR = registerBlock(FOTBlocks.COCONUT_TRAPDOOR, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    public static final Item COCONUT_DOOR = register("coconut_door", properties -> new DoubleHighBlockItem(FOTBlocks.COCONUT_DOOR, properties.useBlockDescriptionPrefix().cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS)));
    public static final Item COCONUT_SIGN = register("coconut_sign", properties -> new StandingAndWallBlockItem(FOTBlocks.COCONUT_SIGN, FOTBlocks.COCONUT_WALL_SIGN, Direction.DOWN, properties.stacksTo(16).useBlockDescriptionPrefix().signText().cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_ITEMS_LARGE)));
    public static final Item COCONUT_HANGING_SIGN = register("coconut_hanging_sign", properties -> new FOTHangingSignItem(FOTBlocks.COCONUT_HANGING_SIGN, FOTBlocks.COCONUT_WALL_HANGING_SIGN, properties.stacksTo(16).useBlockDescriptionPrefix().cookingFuel(ContextIntProviders.COOKING_TIME_HANGING_SIGNS).signText()));

    public static final Item COCONUT_FISH_PLAQUE = registerBlock(FOTBlocks.COCONUT_FISH_PLAQUE, properties -> properties.cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));
    ...
    public static final Item COCONUT_SHELF = registerBlock(FOTBlocks.COCONUT_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY).cookingFuel(ContextIntProviders.COOKING_TIME_WOOD_BLOCKS));

    // Item
    public static final Item EARTHWORMS = register("earthworms", properties -> new FOTWormItem(properties.food(FOTFoodProperties.WORMS, FOTConsumables.WORMS).compostable(FOTContextIntProviders.COMPOSTABLE_LOW_40)));
    public static final Item GRUBS = register("grubs", properties -> new FOTWormItem(properties.food(FOTFoodProperties.WORMS, FOTConsumables.WORMS).compostable(FOTContextIntProviders.COMPOSTABLE_LOW_40)));
    public static final Item LEECHES = register("leeches", properties -> new FOTWormItem(properties.food(FOTFoodProperties.WORMS, FOTConsumables.WORMS).compostable(FOTContextIntProviders.COMPOSTABLE_LOW_40)));
    ...
    public static final Item COCONUT = register("coconut", properties -> new BlockItem(FOTBlocks.COCONUT_SAPLING, properties.useItemDescriptionPrefix().food(FOTFoodProperties.COCONUT).compostable(ContextIntProviders.COMPOSTABLE_LOW_MEDIUM)));
    public static final Item BANANA = register("banana", new Item.Properties().food(FOTFoodProperties.BANANA).compostable(ContextIntProviders.COMPOSTABLE_LOW));
    public static final Item HALF_PINEAPPLE = register("half_pineapple", new Item.Properties().food(FOTFoodProperties.HALF_PINEAPPLE).compostable(FOTContextIntProviders.COMPOSTABLE_LOW_35));
    public static final Item PINEAPPLE = register("pineapple", properties -> new ReturnedOnConsumeItem(properties.food(FOTFoodProperties.PINEAPPLE).compostable(FOTContextIntProviders.COMPOSTABLE_MEDIUM_70), () -> FOTItems.HALF_PINEAPPLE));
    public static final Item CROWNLESS_PINEAPPLE = register("crownless_pineapple", properties -> new ReturnedOnConsumeItem(properties.food(FOTFoodProperties.PINEAPPLE).compostable(ContextIntProviders.COMPOSTABLE_MEDIUM), () -> FOTItems.HALF_PINEAPPLE));
    public static final Item PINEAPPLE_SEEDS = register("pineapple_seeds", properties -> new PineappleBlockItem(false, properties.useItemDescriptionPrefix().compostable(FOTContextIntProviders.COMPOSTABLE_VERY_LOW_10)));
    public static final Item PINEAPPLE_CROWN = register("pineapple_crown", properties -> new PineappleBlockItem(true, properties.useItemDescriptionPrefix().compostable(FOTContextIntProviders.COMPOSTABLE_VERY_LOW_15)));
    public static final Item MANGO = register("mango", properties -> new ReturnedOnConsumeItem(properties.food(FOTFoodProperties.MANGO).compostable(ContextIntProviders.COMPOSTABLE_LOW), () -> FOTItems.MANGO_PIT, 0.2f));
    public static final Item RAW_MANGO = register("raw_mango", properties -> new ReturnedOnConsumeItem(properties.food(FOTFoodProperties.RAW_MANGO, FOTConsumables.RAW_MANGO_CONSUMABLE).compostable(ContextIntProviders.COMPOSTABLE_LOW), () -> FOTItems.MANGO_PIT, 0.2f));
    public static final Item POMEGRANATE = register("pomegranate", properties -> new ReturnedOnConsumeItem(properties.food(FOTFoodProperties.POMEGRANATE).compostable(FOTContextIntProviders.COMPOSTABLE_VERY_LOW_20), () -> FOTItems.POMEGRANATE_SEEDS, 0.6f));
    public static final Item POMEGRANATE_SEEDS = register("pomegranate_seeds", properties -> new BlockItem(FOTBlocks.POMEGRANATE_SAPLING, properties.useItemDescriptionPrefix().compostable(FOTContextIntProviders.COMPOSTABLE_VERY_LOW_10)));
    public static final Item GUARDIAN_FRUIT = register("guardian_fruit", properties -> new GuardianFruitItem(properties.food(FOTFoodProperties.GUARDIAN_FRUIT, FOTConsumables.GUARDIAN_FRUIT).compostable(ContextIntProviders.COMPOSTABLE_LOW)));
    ...
    public static final Item COCONUT_BOAT = register("coconut_boat", properties -> new BoatItem(FOTEntities.COCONUT_BOAT, properties.stacksTo(1).cookingFuel(ContextIntProviders.COOKING_TIME_BOATS)));
    public static final Item COCONUT_CHEST_BOAT = register("coconut_chest_boat", properties -> new BoatItem(FOTEntities.COCONUT_CHEST_BOAT, properties.stacksTo(1).cookingFuel(ContextIntProviders.COOKING_TIME_BOATS)));
