...
public class FOTItems
{
    ...
    public static final Item SPLASHTAIL_SPAWN_EGG = register("splashtail_spawn_egg", properties -> new FOTSpawnEggItem(FOTEntities.SPLASHTAIL, 10368309, 3949737, properties));
    public static final Item PONDIE_SPAWN_EGG = register("pondie_spawn_egg", properties -> new FOTSpawnEggItem(FOTEntities.PONDIE, 8553918, 6255174, properties));
    public static final Item ISLEHOPPER_SPAWN_EGG = register("islehopper_spawn_egg", properties -> new FOTSpawnEggItem(FOTEntities.ISLEHOPPER, 5854313, 8600128, properties));
    public static final Item ANCIENTSCALE_SPAWN_EGG = register("ancientscale_spawn_egg", properties -> new FOTSpawnEggItem(FOTEntities.ANCIENTSCALE, 16224860, 7878952, properties));
    public static final Item PLENTIFIN_SPAWN_EGG = register("plentifin_spawn_egg", properties -> new FOTSpawnEggItem(FOTEntities.PLENTIFIN, 12901959, 3298579, properties));
    public static final Item WILDSPLASH_SPAWN_EGG = register("wildsplash_spawn_egg", properties -> new FOTSpawnEggItem(FOTEntities.WILDSPLASH, 6453062, 7556888, properties));
    public static final Item DEVILFISH_SPAWN_EGG = register("devilfish_spawn_egg", properties -> new FOTSpawnEggItem(FOTEntities.DEVILFISH, 8618392, 13068147, properties));
    public static final Item BATTLEGILL_SPAWN_EGG = register("battlegill_spawn_egg", properties -> new FOTSpawnEggItem(FOTEntities.BATTLEGILL, 2311985, 11047794, properties));
    public static final Item WRECKER_SPAWN_EGG = register("wrecker_spawn_egg", properties -> new FOTSpawnEggItem(FOTEntities.WRECKER, 12022988, 4597359, properties));
    public static final Item STORMFISH_SPAWN_EGG = register("stormfish_spawn_egg", properties -> new FOTSpawnEggItem(FOTEntities.STORMFISH, 9541044, 8608620, properties));
