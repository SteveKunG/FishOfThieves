...
import com.stevekung.fishofthieves.neoforge.mixin.internal.LootTableAccessor;
...
public interface FabricLootTableBuilder
{
     ...
     */
    default void pools(Collection<? extends LootPool> pools)
    {
        throw new UnsupportedOperationException("Implemented via mixin");
    }
     ...
     */
    default void apply(Collection<? extends LootItemFunction> functions)
    {
        throw new UnsupportedOperationException("Implemented via mixin");
    }
     ...
     * instead of both.
     *
     * <p>Calling this method turns all pools into builders and rebuilds them back into loot pools afterward,
     * so it is more efficient to do all transformations with one {@code modifyPools} call.
     *
     * @param modifier the modifying function
     */
    default void modifyPools(Consumer<? super LootPool.Builder> modifier)
    {
        throw new UnsupportedOperationException("Implemented via mixin");
    }
