...
public class FOTBiomeModifiers
{
    private static final RegistrySetBuilder BUILDER = new RegistrySetBuilder()
            .add(Registries.FEATURE, FOTFeatures::bootstrap)
            .add(Registries.PLACED_FEATURE, FOTPlacements::bootstrap)
            .add(NeoForgeRegistries.Keys.BIOME_MODIFIERS, context ->
            {
                context.register(key("add_splashtails"), spawn(context, FOTTags.Biomes.SPAWNS_SPLASHTAILS, new Weighted<>(new MobSpawnSettings.SpawnerData(FOTEntities.SPLASHTAIL, UniformInt.of(4, 8)), FishOfThieves.CONFIG.spawnRate.fishWeight.splashtail)));
                context.register(key("add_pondies"), spawn(context, FOTTags.Biomes.SPAWNS_PONDIES, new Weighted<>(new MobSpawnSettings.SpawnerData(FOTEntities.PONDIE, UniformInt.of(2, 4)), FishOfThieves.CONFIG.spawnRate.fishWeight.pondie)));
                context.register(key("add_islehoppers"), spawn(context, FOTTags.Biomes.SPAWNS_ISLEHOPPERS, new Weighted<>(new MobSpawnSettings.SpawnerData(FOTEntities.ISLEHOPPER, UniformInt.of(2, 4)), FishOfThieves.CONFIG.spawnRate.fishWeight.islehopper)));
                context.register(key("add_ancientscales"), spawn(context, FOTTags.Biomes.SPAWNS_ANCIENTSCALES, new Weighted<>(new MobSpawnSettings.SpawnerData(FOTEntities.ANCIENTSCALE, UniformInt.of(4, 8)), FishOfThieves.CONFIG.spawnRate.fishWeight.ancientscale)));
                context.register(key("add_plentifins"), spawn(context, FOTTags.Biomes.SPAWNS_PLENTIFINS, new Weighted<>(new MobSpawnSettings.SpawnerData(FOTEntities.PLENTIFIN, UniformInt.of(4, 8)), FishOfThieves.CONFIG.spawnRate.fishWeight.plentifin)));
                context.register(key("add_wildsplash"), spawn(context, FOTTags.Biomes.SPAWNS_WILDSPLASH, new Weighted<>(new MobSpawnSettings.SpawnerData(FOTEntities.WILDSPLASH, UniformInt.of(2, 4)), FishOfThieves.CONFIG.spawnRate.fishWeight.wildsplash)));
                context.register(key("add_devilfish"), spawn(context, FOTTags.Biomes.SPAWNS_DEVILFISH, new Weighted<>(new MobSpawnSettings.SpawnerData(FOTEntities.DEVILFISH, UniformInt.of(1, 2)), FishOfThieves.CONFIG.spawnRate.fishWeight.devilfish)));
                context.register(key("add_battlegills"), spawn(context, FOTTags.Biomes.SPAWNS_BATTLEGILLS, new Weighted<>(new MobSpawnSettings.SpawnerData(FOTEntities.BATTLEGILL, UniformInt.of(2, 4)), FishOfThieves.CONFIG.spawnRate.fishWeight.battlegill)));
                context.register(key("add_wreckers"), spawn(context, FOTTags.Biomes.SPAWNS_WRECKERS, new Weighted<>(new MobSpawnSettings.SpawnerData(FOTEntities.WRECKER, UniformInt.of(4, 8)), FishOfThieves.CONFIG.spawnRate.fishWeight.wrecker)));
                context.register(key("add_stormfish"), spawn(context, FOTTags.Biomes.SPAWNS_STORMFISH, new Weighted<>(new MobSpawnSettings.SpawnerData(FOTEntities.STORMFISH, UniformInt.of(4, 8)), FishOfThieves.CONFIG.spawnRate.fishWeight.stormfish)));
    ...
    {
        event.getGenerator().addProvider(true, (DataProvider.Factory<?>) output -> DatapackBuiltinEntriesProvider.forWorldLayer(output, "Biome Modifier Registries: " + FishOfThieves.MOD_ID, event.getWorldLookupProvider(), BUILDER, Set.of(FishOfThieves.MOD_ID)));
    }
