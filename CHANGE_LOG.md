...
- Added Coconut (Item)
  ...
  - It can be used to grow a Coconut Tree by placing on the Sand
  - Can be found inside Shipwreck Supply Chest, Jungle Temple Chest and Seapost Supply Barrel
    - For Jungle Temple Chest, only if Jungle Temple is generated in the Tropical Island biome

### Banana

- Added Banana Clusters
  - It has three states, Underripe, Barely Ripe and Ripe
...
- Added Banana Blossom
  - It can be crafted to Purple Dye
...
- Added Pineapple Block
  - It has three variants, Underripe, Ripe Pineapple and Crownless Pineapple
  - When using Shears to cut the Ripe Pineapple Block, it drops Pineapple Crown and becomes Crownless Pineapple Block
...
- Added Pineapple Seeds
  - It can be used to breed Chicken
...
- All fish no longer flee when the player has Guardian Stifle effect
...
- Moss Islehopper is now spawned in the Tropical Island biome

### Stormfish

- Wild Stormfish is now spawned in the Tropical Island biome

### Wildsplash

- Sandy Wildsplash is now spawned in the Tropical Island biome
...
- Fixed possible mixin conflicts
