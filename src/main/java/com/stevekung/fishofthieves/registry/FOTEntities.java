...
public class FOTEntities
{
    ...
    public static final EntityType<Stormfish> STORMFISH = FabricEntityTypeBuilder.create(MobCategory.WATER_AMBIENT, Stormfish::new).dimensions(EntityDimensions.fixed(0.75F, 0.55F)).trackRangeBlocks(4).build();
