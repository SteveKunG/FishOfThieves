...
public class Devilfish extends AbstractSchoolingThievesFish
{
    ...
    protected void registerGoals()
    {
        ...
        this.targetSelector.addGoal(8, new NearestAttackableTargetGoal<>(this, Monster.class, 20, true, false, livingEntity -> livingEntity.getMobType() == MobType.UNDEAD));
    }
    ...
    {
        return Mob.createMobAttributes().add(Attributes.MAX_HEALTH, 3.0).add(Attributes.FOLLOW_RANGE, 10.0).add(Attributes.ATTACK_DAMAGE, 1.0).add(Attributes.ATTACK_KNOCKBACK, 0.5);
    }
