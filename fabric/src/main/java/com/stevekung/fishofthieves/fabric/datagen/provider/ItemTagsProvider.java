...
public class ItemTagsProvider extends FabricTagsProvider.ItemTagsProvider
{
    ...
    protected void addTags(HolderLookup.Provider provider)
    {
        ...
        this.builder(ItemTags.CHICKEN_FOOD).forceAddTag(FOTTags.Items.WORMS).add(FOTItems.PINEAPPLE_SEEDS, FOTItems.POMEGRANATE_SEEDS);
        this.builder(ItemTags.OCELOT_FOOD).forceAddTag(FOTTags.Items.THIEVES_FISH);
        this.builder(ItemTags.PIG_FOOD).add(FOTItems.COCONUT, FOTItems.BANANA, FOTItems.PINEAPPLE, FOTItems.HALF_PINEAPPLE,
        ...
        this.builder(ItemTags.BEE_FOOD).add(FOTItems.BANANA_BLOSSOM, FOTItems.PINK_PLUMERIA, FOTItems.LIGHT_BLUE_PLUMERIA, FOTItems.WHITE_PLUMERIA);
        this.builder(ItemTags.FISHES).forceAddTag(FOTTags.Items.THIEVES_FISH).forceAddTag(FOTTags.Items.COOKED_THIEVES_FISH);
        this.builder(ItemTags.SIGNS).add(FOTItems.COCONUT_SIGN);
        this.builder(ItemTags.HANGING_SIGNS).add(FOTItems.COCONUT_HANGING_SIGN);
        this.builder(ItemTags.WOODEN_DOORS).add(FOTItems.COCONUT_DOOR);
        this.builder(ItemTags.WOODEN_TRAPDOORS).add(FOTItems.COCONUT_TRAPDOOR);
        this.builder(ItemTags.LOGS).forceAddTag(FOTTags.Items.COCONUT_LOGS).add(FOTItems.BANANA_STEM);
        this.builder(ItemTags.LOGS_THAT_BURN).forceAddTag(FOTTags.Items.COCONUT_LOGS).add(FOTItems.BANANA_STEM);
        this.builder(ItemTags.LEAVES).add(FOTItems.COCONUT_FRONDS, FOTItems.BANANA_LEAVES,
                FOTItems.MANGO_LEAVES);
        this.builder(ItemTags.PLANKS).add(FOTItems.COCONUT_PLANKS);
        this.builder(ItemTags.WOODEN_BUTTONS).add(FOTItems.COCONUT_BUTTON);
        this.builder(ItemTags.WOODEN_STAIRS).add(FOTItems.COCONUT_STAIRS);
        this.builder(ItemTags.WOODEN_SLABS).add(FOTItems.COCONUT_SLAB);
        this.builder(ItemTags.WOODEN_FENCES).add(FOTItems.COCONUT_FENCE);
        this.builder(ItemTags.FENCE_GATES).add(FOTItems.COCONUT_FENCE_GATE);
        this.builder(ItemTags.WOODEN_PRESSURE_PLATES).add(FOTItems.COCONUT_PRESSURE_PLATE);
        this.builder(ItemTags.BOATS).add(FOTItems.COCONUT_BOAT);
        this.builder(ItemTags.CHEST_BOATS).add(FOTItems.COCONUT_CHEST_BOAT);
        this.builder(ItemTags.SAPLINGS).add(FOTItems.COCONUT, FOTItems.BANANA_SHOOTS,
                FOTItems.MANGO_SAPLING);
        this.builder(ItemTags.SMALL_FLOWERS).add(FOTItems.BANANA_BLOSSOM, FOTItems.PINK_PLUMERIA, FOTItems.LIGHT_BLUE_PLUMERIA, FOTItems.WHITE_PLUMERIA);
        this.builder(ItemTags.DECORATED_POT_SHERDS).add(FOTItems.STORMFISH_POTTERY_SHERD,
                FOTItems.KRAKEN_POTTERY_SHERD, FOTItems.MEGALODON_POTTERY_SHERD, FOTItems.GREAT_MOUTH_POTTERY_SHERD);
        this.builder(ItemTags.NAUTILUS_TAMING_ITEMS).add(FOTItems.ISLEHOPPER, FOTItems.ISLEHOPPER_BUCKET);
        this.builder(ItemTags.NAUTILUS_BUCKET_FOOD).forceAddTag(FOTTags.Items.THIEVES_FISH_BUCKET);

        this.builder(FOTTags.Items.THIEVES_FISH_BUCKET).add(FOTTags.FISH_BUCKETS);
        this.builder(FOTTags.Items.THIEVES_FISH).add(rawFishes);
        this.builder(FOTTags.Items.COOKED_THIEVES_FISH).add(cookedFishes);
        ...
        this.builder(FOTTags.Items.EARTHWORMS_FOOD).add(FOTItems.EARTHWORMS);
        this.builder(FOTTags.Items.GRUBS_FOOD).add(FOTItems.GRUBS);
        this.builder(FOTTags.Items.LEECHES_FOOD).add(FOTItems.LEECHES);
        this.builder(FOTTags.Items.FISH_PLAQUE_BUCKET_BLACKLIST);
        this.builder(FOTTags.Items.WOODEN_FISH_PLAQUE).add(FOTItems.OAK_FISH_PLAQUE, FOTItems.SPRUCE_FISH_PLAQUE,
        ...
        this.builder(ConventionalItemTags.ENTITY_WATER_BUCKETS).add(FOTTags.FISH_BUCKETS);

        // Croptopia compatibility
        this.builder(CROPTOPIA_FISHES).forceAddTag(FOTTags.Items.THIEVES_FISH);

        // NeoForge
        this.builder(ConventionalItemTags.CROPS).add(FOTItems.COCONUT, FOTItems.BANANA, FOTItems.PINEAPPLE, FOTItems.CROWNLESS_PINEAPPLE, FOTItems.MANGO, FOTItems.RAW_MANGO, FOTItems.POMEGRANATE, FOTItems.GUARDIAN_FRUIT);
        this.builder(C_SEEDS).add(FOTItems.MANGO_PIT, FOTItems.PINEAPPLE_SEEDS, FOTItems.POMEGRANATE_SEEDS);
        this.builder(ConventionalItemTags.FRUIT_FOODS).add(FOTItems.COCONUT, FOTItems.BANANA, FOTItems.PINEAPPLE, FOTItems.CROWNLESS_PINEAPPLE, FOTItems.MANGO, FOTItems.RAW_MANGO, FOTItems.POMEGRANATE, FOTItems.GUARDIAN_FRUIT);
        this.builder(C_FRUITS_SWEET).add(FOTItems.BANANA, FOTItems.PINEAPPLE, FOTItems.MANGO, FOTItems.POMEGRANATE, FOTItems.GUARDIAN_FRUIT);

        this.builder(FOTTags.Items.SERENE_SEASONS_YEAR_ROUND_CROPS).add(FOTItems.BANANA, FOTItems.BANANA_SHOOTS, FOTItems.GUARDIAN_FRUIT)
                .forceAddTag(FOTTags.Items.BANANA_CLUSTERS);
        this.builder(FOTTags.Items.SERENE_SEASONS_SPRING_CROPS).add(FOTItems.PINEAPPLE, FOTItems.CROWNLESS_PINEAPPLE, FOTItems.HALF_PINEAPPLE,
        ...
        this.builder(FOTTags.Items.SERENE_SEASONS_SUMMER_CROPS).add(FOTItems.COCONUT, FOTItems.PINEAPPLE, FOTItems.CROWNLESS_PINEAPPLE,
                ...
                FOTItems.MANGO, FOTItems.RAW_MANGO, FOTItems.MANGO_PIT, FOTItems.MANGO_SAPLING, FOTItems.POMEGRANATE,
                FOTItems.POMEGRANATE_SEEDS, FOTItems.POMEGRANATE_PLANT, FOTItems.TALL_POMEGRANATE_PLANT);
        this.builder(FOTTags.Items.SERENE_SEASONS_AUTUMN_CROPS).add(FOTItems.POMEGRANATE,
                FOTItems.POMEGRANATE_SEEDS, FOTItems.POMEGRANATE_PLANT, FOTItems.TALL_POMEGRANATE_PLANT);
    }
}