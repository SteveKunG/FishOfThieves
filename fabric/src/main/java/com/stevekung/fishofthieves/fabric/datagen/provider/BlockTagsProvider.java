...
public class BlockTagsProvider extends FabricTagProvider.BlockTagProvider
{
    ...
    protected void addTags(HolderLookup.Provider provider)
    {
        ...
        this.getOrCreateTagBuilder(BlockTags.SMALL_FLOWERS).add(FOTBlocks.PINK_PLUMERIA, FOTBlocks.LIGHT_BLUE_PLUMERIA, FOTBlocks.WHITE_PLUMERIA);
        ...
        {
            replaceableList.forEach(this.getOrCreateTagBuilder(BlockTags.REPLACEABLE)::add);
        }
        ...
        this.getOrCreateTagBuilder(FOTTags.Blocks.COPPER_FRAME_FISH_PLAQUE).add(FOTBlocks.COPPER_FRAME_OAK_FISH_PLAQUE, FOTBlocks.COPPER_FRAME_SPRUCE_FISH_PLAQUE,
                ...
                FOTBlocks.COPPER_FRAME_DARK_OAK_FISH_PLAQUE, FOTBlocks.COPPER_FRAME_MANGROVE_FISH_PLAQUE, FOTBlocks.COPPER_FRAME_CHERRY_FISH_PLAQUE,
        ...
        this.getOrCreateTagBuilder(FOTTags.Blocks.FISH_PLAQUE)
                .forceAddTag(FOTTags.Blocks.WOODEN_FISH_PLAQUE)
                .forceAddTag(FOTTags.Blocks.IRON_FRAME_FISH_PLAQUE)
                .forceAddTag(FOTTags.Blocks.COPPER_FRAME_FISH_PLAQUE)
                .forceAddTag(FOTTags.Blocks.GOLDEN_FRAME_FISH_PLAQUE)
                .forceAddTag(FOTTags.Blocks.GILDED_FRAME_FISH_PLAQUE);
        ...
        this.getOrCreateTagBuilder(FOTTags.Blocks.SMALL_COCONUT_LOGS).add(FOTBlocks.SMALL_COCONUT_LOG, FOTBlocks.SMALL_COCONUT_WOOD,
                FOTBlocks.COCONUT_FRUIT_GROWABLE_LOG, FOTBlocks.SMALL_TOP_COCONUT_LOG,
                FOTBlocks.STRIPPED_SMALL_COCONUT_LOG, FOTBlocks.STRIPPED_SMALL_COCONUT_WOOD);
        this.getOrCreateTagBuilder(FOTTags.Blocks.COCONUT_GROWABLE_LOG_SPAWNABLE_BELOW).forceAddTag(FOTTags.Blocks.SMALL_COCONUT_LOGS).add(FOTBlocks.MEDIUM_COCONUT_LOG);
        ...
        this.getOrCreateTagBuilder(FOTTags.Blocks.SERENE_SEASONS_YEAR_ROUND_CROPS)
                .add(FOTBlocks.BANANA_SHOOTS, FOTBlocks.BANANA_SHOOTS_PLANT,
                        FOTBlocks.GUARDIAN_FRUIT)
                .forceAddTag(FOTTags.Blocks.BANANA_CLUSTERS)
                .forceAddTag(FOTTags.Blocks.BANANA_CLUSTER_PLANTS);
        this.getOrCreateTagBuilder(FOTTags.Blocks.SERENE_SEASONS_SPRING_CROPS)
        ...
        this.getOrCreateTagBuilder(FOTTags.Blocks.SERENE_SEASONS_SUMMER_CROPS)
                .add(FOTBlocks.COCONUT_SAPLING, FOTBlocks.COCONUT_FRUIT,
                        ...
                        FOTBlocks.POMEGRANATE_PLANT, FOTBlocks.TALL_POMEGRANATE_PLANT)
                .forceAddTag(FOTTags.Blocks.MANGO_FRUITS);
        this.getOrCreateTagBuilder(FOTTags.Blocks.SERENE_SEASONS_AUTUMN_CROPS)
                .add(FOTBlocks.POMEGRANATE_SAPLING, FOTBlocks.POMEGRANATE_PLANT, FOTBlocks.TALL_POMEGRANATE_PLANT);
        this.getOrCreateTagBuilder(FOTTags.Blocks.SERENE_SEASONS_UNBREAKABLE_INFERTILE_CROPS)
