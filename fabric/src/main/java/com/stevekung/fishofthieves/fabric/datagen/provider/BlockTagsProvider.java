...
public class BlockTagsProvider extends FabricTagsProvider.BlockTagsProvider
{
    ...
    protected void addTags(HolderLookup.Provider provider)
    {
        ...
        this.builder(FOTTags.Blocks.IRON_FRAME_FISH_PLAQUE).add(FOTBlockItemIds.IRON_FRAME_OAK_FISH_PLAQUE, FOTBlockItemIds.IRON_FRAME_SPRUCE_FISH_PLAQUE,
                ...
                FOTBlockItemIds.IRON_FRAME_DARK_OAK_FISH_PLAQUE, FOTBlockItemIds.IRON_FRAME_MANGROVE_FISH_PLAQUE, FOTBlockItemIds.IRON_FRAME_CHERRY_FISH_PLAQUE, FOTBlockItemIds.IRON_FRAME_PALE_OAK_FISH_PLAQUE, FOTBlockItemIds.IRON_FRAME_POPLAR_FISH_PLAQUE,
        ...
        this.builder(FOTTags.Blocks.COPPER_FRAME_FISH_PLAQUE).add(FOTBlockItemIds.COPPER_FRAME_OAK_FISH_PLAQUE, FOTBlockItemIds.COPPER_FRAME_SPRUCE_FISH_PLAQUE,
                ...
                FOTBlockItemIds.COPPER_FRAME_DARK_OAK_FISH_PLAQUE, FOTBlockItemIds.COPPER_FRAME_MANGROVE_FISH_PLAQUE, FOTBlockItemIds.COPPER_FRAME_CHERRY_FISH_PLAQUE, FOTBlockItemIds.COPPER_FRAME_PALE_OAK_FISH_PLAQUE, FOTBlockItemIds.COPPER_FRAME_POPLAR_FISH_PLAQUE,
        ...
        this.builder(FOTTags.Blocks.GOLDEN_FRAME_FISH_PLAQUE).add(FOTBlockItemIds.GOLDEN_FRAME_OAK_FISH_PLAQUE, FOTBlockItemIds.GOLDEN_FRAME_SPRUCE_FISH_PLAQUE,
                ...
                FOTBlockItemIds.GOLDEN_FRAME_DARK_OAK_FISH_PLAQUE, FOTBlockItemIds.GOLDEN_FRAME_MANGROVE_FISH_PLAQUE, FOTBlockItemIds.GOLDEN_FRAME_CHERRY_FISH_PLAQUE, FOTBlockItemIds.GOLDEN_FRAME_PALE_OAK_FISH_PLAQUE, FOTBlockItemIds.GOLDEN_FRAME_POPLAR_FISH_PLAQUE,
        ...
        this.builder(FOTTags.Blocks.GILDED_FRAME_FISH_PLAQUE).add(FOTBlockItemIds.GILDED_OAK_FISH_PLAQUE, FOTBlockItemIds.GILDED_SPRUCE_FISH_PLAQUE,
                ...
                FOTBlockItemIds.GILDED_MANGROVE_FISH_PLAQUE, FOTBlockItemIds.GILDED_CHERRY_FISH_PLAQUE, FOTBlockItemIds.GILDED_PALE_OAK_FISH_PLAQUE, FOTBlockItemIds.GILDED_POPLAR_FISH_PLAQUE, FOTBlockItemIds.GILDED_BAMBOO_FISH_PLAQUE, FOTBlockItemIds.GILDED_CRIMSON_FISH_PLAQUE,
